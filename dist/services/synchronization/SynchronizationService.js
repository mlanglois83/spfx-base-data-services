                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _loop_1 = function (index) {
                            var transaction, itemType, dataService, item, _a, oldId_1, isAdd, updatedItem_1, nextTransactions, error_1;
                                ...
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        switch (_a) {
                                            ...
                                            case TransactionType.Delete: return [3 /*break*/, 13];
                                        }
                                        return [3 /*break*/, 18];
                                    case 1:
                                        oldId_1 = item.id;
                                    ...
                                    case 2:
                                        ...
                                        if (!(isAdd && !updatedItem_1.error)) return [3 /*break*/, 7];
                                        nextTransactions = [];
                                        if (!(index < transactions.length - 1)) return [3 /*break*/, 4];
                                    ...
                                    case 6:
                                        ...
                                        _b.label = 7;
                                    case 7:
                                        if (!updatedItem_1.error) return [3 /*break*/, 10];
                                        errors.push(this_1.formatError(transaction, updatedItem_1.error.message));
                                        if (!(updatedItem_1.error.name === Constants.Errors.ItemVersionConfict)) return [3 /*break*/, 9];
                                        return [4 /*yield*/, this_1.transactionService.deleteItem(transaction)];
                                    case 8:
                                        _b.sent();
                                        _b.label = 9;
                                    case 9: return [3 /*break*/, 12];
                                    case 10: return [4 /*yield*/, this_1.transactionService.deleteItem(transaction)];
                                    case 11:
                                        _b.sent();
                                        _b.label = 12;
