...
import { sp, SearchQueryBuilder, SearchResults, SortDirection, SearchResult } from "@pnp/sp";

import { IBaseItem, BaseDataService, SPItem, ServicesConfiguration, FieldType, IQuery, TaxonomyTerm, IFieldDescriptor, ILogicalSequence, IPredicate, LogicalOperator, TestOperator } from "../..";
...
export class SearchService<T extends IBaseItem> extends BaseDataService<T>{
     ...
     * @param searchItem 
     */
    private getItemFromSearchResult(searchItem: SearchResult): T {
